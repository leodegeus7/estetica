-- Primeiro, encontre o service_id da Toxina Botulínica:
SELECT id, name FROM services WHERE name LIKE '%Toxina%';

-- Depois execute isto (substitua 'UUID-AQUI' pelo ID encontrado acima):
